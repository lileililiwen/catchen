...
class RegisterResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is RegisterResponse && other.userId == userId;
  ...
  @override
  String toString() => 'RegisterResponse[userId=$userId]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "RegisterResponse[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "RegisterResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RegisterResponse> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<RegisterResponse>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = RegisterResponse.listFromJson(
          entry.value,
          growable: growable,
        );
      }
